...
class DijkstraAllgemeinTest extends PHPUnit_Framework_TestCase {
    ...
    function testDijkstra() {
        ...
        list($transitions, $costs) = $dijkstra->getShortestPath($initial);
...
class Dijkstra {
    ...
    public function getShortestPath(array $initial) {
        $visited = array();
